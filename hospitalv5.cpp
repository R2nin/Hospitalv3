...
#include <iomanip> // biblioteca para manipulação de saída de dados
#include <algorithm> // biblioteca para algoritmos de ordenação e busca
...
struct CID {
    int codigo;
    std::string descricaoc; // corrigido para 'descricao'
};
